			...
			// start root.PE.Components
			{
				PE::Components::Component::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::SceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						...
						PE::Components::PSysSceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						...
						PE::Components::ParticleManager::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::PSysMesh::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
