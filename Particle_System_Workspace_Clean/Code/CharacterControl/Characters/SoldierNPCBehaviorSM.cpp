...
void SoldierNPCBehaviorSM::do_PRE_RENDER_needsRC(PE::Events::Event *pEvt)
{
	...
	for (int i = 200; i < 400; i++) {
		pSystemTemp[i] = Vector3((float)i - 200.0f, 0.0f, 0.0f);
	}
	for (int i = 400; i < 600; i++) {
		pSystemTemp[i] = Vector3(0.0f, 0.0f, (float)i - 400.0f);
	}
	pSystemTemp[0] = Vector3(0.0f, 0.0f, 0.0f);
	pSystemTemp[1] = Vector3(100.0f, 0.0f, 0.0f);
	pSystemTemp[4] = Vector3(-100.0f, 0.0f, 0.0f);
	pSystemTemp[2] = Vector3(0.0f, 100.0f, 0.0f);
	pSystemTemp[5] = Vector3(0.0f, -100.0f, 0.0f);
	pSystemTemp[3] = Vector3(0.0f, 0.0f, 100.0f);
